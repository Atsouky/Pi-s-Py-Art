...
def select_jv1():
    ...
    while s_jv1:
        ...
        button_5 = fenetre.blit(bouttons_mnca,(x/3.5,y/2))
        button_6 = fenetre.blit(bouttons_seeds,(x/2,y/2))
...
def select_other():
    ...
    while s_other:
        ...
        if button_3.collidepoint((mx, my)):
            if click:
                subprocess.run(["python", "MNCA/CSV file editor.py"])
        if button_4.collidepoint((mx, my)):
            if click:
                s_other=False
                sim=True
...
def select_other2():
    ...
    while s_other2:
        ...
        button_1 = fenetre.blit(bouttons_xor,(x/3.55,y/7.5))
        button_2 = fenetre.blit(bouttons_pile,(x/2,y/7.5))
